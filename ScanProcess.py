...
engine =pyttsx3.init()      # declare pyttsx3 Module
voices = engine.getProperty('voice') #
engine.setProperty('voice',voices[0]) # voice requirement
